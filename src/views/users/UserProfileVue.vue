...
<!-- Change Password Form -->
                            <form @submit.prevent="updatePwd()">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input v-model="currentPwd" name="password" type="password" class="form-control" id="currentPassword">
                                </div>
                                </div>
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input v-model="newUserName" name="newpassword" type="password" class="form-control" id="newPassword">
                                </div>
                                </div>
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input v-model="newConfirmpwd" name="renewpassword" type="password" class="form-control" id="renewPassword">
                                </div>
                                </div>
...
// import { db } from '@/firebase/fonction'
// import { computed } from '@vue/runtime-core'
// const userId =computed(()=>route.params.id)
// // const updatePasseWordReff =doc(db,"utilisateur ")
// const userRef = doc(db,utillisateurs,user.uid)
...
// export default {
    ...
    //     //   FonctionGenrique.update(UserCollectionRefs, ).then(()=>{
    //     //       this.submited = true;
    //     //     })
    //     //     .catch(e=>{
    //     //       console.log(e);
