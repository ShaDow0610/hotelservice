                ...
                <div class="card-body">
                  ...
                  <form @submit.prevent=" login()" class="row g-3 needs-validation" novalidate="">
                    ...
                    <div class="col-12">
                      ...
                      <input v-model="logInEmail" type="email" name="email" class="form-control" id="yourEmail" required="">
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Password</label>
                      <input v-model="logInPwd" type="password" name="password" class="form-control" id="yourPassword" required="">
...
import { auth } from  '@/firebase/index'
    ...
    export default {
      ...
      methods:{
          login(){
              return signInWithEmailAndPassword(auth, this.logInEmail, this.logInPwd).then((cred) => {
            // Signed in
              this.error = false
              this.erroMsg=""
